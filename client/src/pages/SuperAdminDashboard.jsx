                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <span className={`inline-flex items-center gap-1 mt-2 px-2.5 py-1 rounded-lg text-xs uppercase font-bold tracking-wider ${
                                u.role === 'superadmin' ? 'bg-gradient-to-r from-rose-100 to-orange-100 text-rose-700 dark:from-rose-900/30 dark:to-orange-900/30 dark:text-rose-300' :
                                ...
                                u.role === 'manager' ? 'bg-gradient-to-r from-slate-100 to-gray-100 text-slate-700 dark:from-slate-900/30 dark:to-gray-900/30 dark:text-slate-300' :
...
function NavButton({ active, onClick, icon, label, gradient }) {
  return (
    ...
    >
      {active && (
        <motion.div
          layoutId="sidebar-active-superadmin"
