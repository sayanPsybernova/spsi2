  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'emerald-glow': 'linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%)',
      },
      boxShadow: {
        ...
        'card-hover': '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.1)',
      },
      animation: {
        ...
        'text-shine': 'text-shine 5s ease-in-out infinite',
      ...
      keyframes: {
        ...
        spotlight: {
          '0%': { opacity: 0, transform: 'translateX(-50%) translateY(-100%) scale(0.3)' },
